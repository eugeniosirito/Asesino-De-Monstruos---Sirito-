new Vue({
    ...
    methods: {
        ...
        ataqueEspecial: function () {
            ...
            this.turnos.unshift({
                esJugador: true,
                text: 'El jugador golpea fuertemente al monstruo por ' + danio
            });
        ...
        curar: function () {
            var sanar = this.calcularHeridas(5, 15);
            this.saludJugador += sanar;
            this.turnos.unshift({
                esJugador: true,
                text: 'El jugador se cura por ' + sanar
            });
        ...
        ataqueDelMonstruo: function () {
            ...
            this.turnos.unshift({
                esJugador: false,
                text: 'El monstruo daña al jugador por ' + danio
            });
